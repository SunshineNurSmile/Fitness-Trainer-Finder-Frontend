    ...
    methods: {
        initPerMsg() {
            $.ajax({
                ...
                url: "http://35.227.26.131/api/users/trainers/payment/get/",
                type: "GET",
        ...
        submit() {
            ...
            if (this.put == false) {
                $.ajax({
                    ...
                    url: "http://35.227.26.131/api/users/trainers/payment/create/",
                    type: "POST",
                    data: data,
                    dataType: "json",
                ...
                $.ajax({
                    ...
                    url: "http://35.227.26.131/api/users/trainers/payment/update/",
                    type: "PUT",
                    data: data,
                    dataType: "json",
                    contentType: "application/json; charset=utf_8",
