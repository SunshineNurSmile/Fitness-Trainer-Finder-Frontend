    ...
    methods: {
        get_trainer_info() {
            $.ajax({
                ...
                url: "http://35.227.26.131:8000/api/users/trainees/mytrainer/",
                type: "GET",
        ...
        get_order_info() {
            $.ajax({
                ...
                url: "http://35.227.26.131:8000/api/orders/myorders/",
                type: "GET",
        ...
        getVideo(id) {
            $.ajax({
                ...
                url: "http://35.227.26.131:8000/api/users/trainers/file/" + id + "/",
                type: "GET",
